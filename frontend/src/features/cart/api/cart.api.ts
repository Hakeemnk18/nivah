...
import type { AddCartItemPayload, CheckoutResponse, GetCartItemsCountResponse, GetCartResponse, RemoveCartItemPayload, UpdateCartCountPayload } from "../type/cart.type";
...
export const getCartItemsCountApi = async (
    guestId: string
