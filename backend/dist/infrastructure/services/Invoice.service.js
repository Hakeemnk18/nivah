...
export class InvoiceService {
    async generateInvoice(order) {
        ...
        doc.registerFont("Roboto", path.resolve(__dirname, "../../assets/fonts/Roboto-Regular.ttf"));
        doc.registerFont("Roboto-Bold", path.resolve(__dirname, "../../assets/fonts/Roboto-Bold.ttf"));
        doc.font("Roboto");
        const buffers = [];
        ...
        return new Promise((resolve, reject) => {
            ...
            for (const item of order.items) {
                ...
                const productHeight = doc.heightOfString(item.name, { width: 200 });
                doc
                    .fontSize(10)
            ...
            doc
                ...
                ? "Free"
                : formatCurrency(order.shippingFee), valueX, position);
            position += 25;
            doc
                .font("Roboto-Bold")
                .fontSize(13)
            ...
            doc
                ...
                .fontSize(11)
                .fillColor("gray")
                .text("Thank you for shopping with NIVAH.", 50, footerY, { align: "center", width: doc.page.width - 100 });
            doc
                .fontSize(9)
                .fillColor("#888888")
                .text("This is a system-generated invoice. No signature required.", 50, footerY + 18, { align: "center", width: doc.page.width - 100 });
            doc
                .fontSize(9)
                .fillColor("#888888")
                .text("End of Document", 50, footerY + 25, { align: "center", width: doc.page.width - 100 });
            doc.end();
        });
    }
}
