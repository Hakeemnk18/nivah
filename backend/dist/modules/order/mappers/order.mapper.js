...
export class OrderMapper {
    /* ================= DOMAIN ================= */
    static toDomain(orderModelData) {
        if (!orderModelData) {
            return null;
        }
        const idString = orderModelData._id?.toString() || orderModelData.id?.toString();
        if (!idString) {
        ...
        return new Order({
            ...
            items: orderModelData.items?.map((item) => ({
    ...
    /* ================= PERSISTENCE ================= */
    static toPersistence(orderEntity) {
        return {
    ...
    static toSummaryView(orderModelData) {
        if (!orderModelData)
            return null;
    ...
    //   /* ================= ADMIN LIST VIEW ================= */
    static toAdminOrderListItem(orderModelData) {
        if (!orderModelData)
            return null;
        const id = orderModelData._id?.toString() || orderModelData.id?.toString();
        if (!id) {
    ...
    static toTopAndLowSellingProductItem(data) {
        if (!data)
            return null;
    ...
    static toTopSellingCategoryItem(data) {
        if (!data)
            return null;
    ...
    /* ================= ADMIN DETAIL VIEW ================= */
    static toAdminOrderFullView(order, payment) {
        return {
