...
let DownloadInvoiceUseCase = class DownloadInvoiceUseCase {
    orderRepository;
    invoiceService;
...
DownloadInvoiceUseCase = __decorate([
    injectable(),
    __param(0, inject("IOrderRepository")),
    __param(1, inject("IInvoiceService")),
    __metadata("design:paramtypes", [Object, Object])
], DownloadInvoiceUseCase);
export { DownloadInvoiceUseCase };
//# sourceMappingURL=download.invoice.use-case.js.map