...
let GetHeroAdminUseCase = class GetHeroAdminUseCase {
    _heroRepository;
...
GetHeroAdminUseCase = __decorate([
    injectable(),
    __param(0, inject("IHeroRepository")),
    __metadata("design:paramtypes", [Object])
], GetHeroAdminUseCase);
export { GetHeroAdminUseCase };
//# sourceMappingURL=get.hero.admin.use-case.js.map