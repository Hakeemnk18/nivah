...
let GetBannerByIdUseCase = class GetBannerByIdUseCase {
    _bannerRepository;
...
GetBannerByIdUseCase = __decorate([
    injectable(),
    __param(0, inject("IBannerRepository")),
    __metadata("design:paramtypes", [Object])
], GetBannerByIdUseCase);
export { GetBannerByIdUseCase };
//# sourceMappingURL=get.banner.by.id.use-case.js.map