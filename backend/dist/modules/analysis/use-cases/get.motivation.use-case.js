...
let GetMotivationUseCase = class GetMotivationUseCase {
    _orderRepository;
    ...
    calculateNextTarget(current, type) {
        if (current === 0)
            return { value: type === "revenue" ? 10000 : 50, progress: 0 };
        ...
        if (type === "orders" && target <= 10)
            target = 10;
        else if (type === "orders" && target <= 50)
            target = 50;
        return {
            value: target,
...
GetMotivationUseCase = __decorate([
    injectable(),
    __param(0, inject("IOrderRepository")),
    __metadata("design:paramtypes", [Object])
], GetMotivationUseCase);
export { GetMotivationUseCase };
//# sourceMappingURL=get.motivation.use-case.js.map